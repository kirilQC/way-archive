...
import { noDashesDeep } from './text.js';
import { canonicalBooks } from './books.js';
    ...
    await supabase.from('sermons').upsert(
      {
        ...
        bible_books: canonicalBooks(analysis.bible_books),
        verses: analysis.verses,
        topics: analysis.topics,
        speaker: analysis.speaker || null,
        series: analysis.series || null,
        discussion_questions: analysis.discussion_questions || null,
        status: 'published',
      },
