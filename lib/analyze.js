...
const TOPICS = [
  ...
  'Holy Spirit', 'Salvation', 'Generosity', 'Fear & Anxiety', 'Rest',
];
...
const SCHEMA = {
  ...
  properties: {
    ...
    topics: {
      type: 'array',
      items: { type: 'string' },
      description: `2-4 topic tags. Prefer tags from this list: ${TOPICS.join(', ')}. Add a freeform tag only if none fit. Never use "Faith" or "Discipleship": they apply to every sermon and are banned.`,
    },
    speaker: {
      type: 'string',
